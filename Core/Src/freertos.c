...
/* Definitions for oldeTask */
osThreadId_t oldeTaskHandle;
uint32_t oldeTaskBuffer[ 256 ];
osStaticThreadDef_t oldeTaskControlBlock;
const osThreadAttr_t oldeTask_attributes = {
  .name = "oldeTask",
  .cb_mem = &oldeTaskControlBlock,
  .cb_size = sizeof(oldeTaskControlBlock),
  .stack_mem = &oldeTaskBuffer[0],
